...
int \mbox{\hyperlink{Couche2_8h_ad6ab3436111cbda26210ac225f2d1575}{delete\+\_\+inode}} (int indice\+\_\+inode)
...
\begin{DoxyCompactList}\small\item\em Ecrit un nouvel inode à la suite des autres sur la table d\textquotesingle{}inode et sur le disque. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{Couche2_8h_a28781830c329397445a59105d8fab819}{init\+\_\+first\+\_\+time\+\_\+super\+\_\+block}} (void)
\begin{DoxyCompactList}\small\item\em Cette fonction initialise le super bloc pour la première fois (initialisation disque ou tests) \end{DoxyCompactList}\item 
int \mbox{\hyperlink{Couche2_8h_a145cc8db54fa03986cf5425c3eb54208}{init\+\_\+first\+\_\+time\+\_\+inodes\+\_\+tables}} (void)
\begin{DoxyCompactList}\small\item\em Cette fonction initialise la table d\textquotesingle{}inodes pour la première fois (initialisation disque ou tests) \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\end{DoxyNote}
\mbox{\Hypertarget{Couche2_8h_ad6ab3436111cbda26210ac225f2d1575}\label{Couche2_8h_ad6ab3436111cbda26210ac225f2d1575}} 
...
{\footnotesize\ttfamily int delete\+\_\+inode (\begin{DoxyParamCaption}\item[{int}]{indice\+\_\+inode }\end{DoxyParamCaption})}
...
Ecrit un nouvel inode à la suite des autres sur la table d\textquotesingle{}inode et sur le disque. 
...
\end{DoxyPrecond}
\begin{DoxyNote}{Note}
Met à jour le la table d\textquotesingle{}inode et le super bloc sur le disque notament first\+\_\+free\+\_\+byte, nblock et number\+\_\+of\+\_\+files. S\textquotesingle{}il n\textquotesingle{}y a plus d\textquotesingle{}inode libre, erreur 1. 
\end{DoxyNote}
...
Cette fonction initialise le super bloc pour la première fois (initialisation disque ou tests) 
...
Cette fonction initialise la table d\textquotesingle{}inodes pour la première fois (initialisation disque ou tests) 
