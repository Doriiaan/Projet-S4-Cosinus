...
Header de li\+Implementation de la couche 2.  
...
\begin{DoxyCompactList}\small\item\em Ecrit le super bloc de la variable systemesur le disque. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{Couche2_8h_a49dbd70d07c45b1c054c89fef22f335e}{read\+\_\+super\+\_\+block}} (void)
\begin{DoxyCompactList}\small\item\em Lis la valeur du super bloc sur le disque et l\textquotesingle{}ecrit sur la variable systeme. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Met a jour le premier octet libre du super bloc dans la variable du systeme et non sur le disque. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{Couche2_8h_aae9a6ce26b7c10156edff96e3ebdcb73}{read\+\_\+inodes\+\_\+table}} (void)
\begin{DoxyCompactList}\small\item\em Lis la valeur de la table d\textquotesingle{}inodes sur le disque et l\textquotesingle{}ecrit sur la variable systeme. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Supprime une inode de la table d\textquotesingle{}inode et met a jour le super bloc. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Ecrit un nouvel inode a la suite des autres sur la table d\textquotesingle{}inode. \end{DoxyCompactList}\item 
...
int \mbox{\hyperlink{Couche2_8h_a28781830c329397445a59105d8fab819}{init\+\_\+first\+\_\+time\+\_\+super\+\_\+block}} (void)
\begin{DoxyCompactList}\small\item\em Cette fonction initialise le super bloc pour la premiere fois. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{Couche2_8h_a145cc8db54fa03986cf5425c3eb54208}{init\+\_\+first\+\_\+time\+\_\+inodes\+\_\+tables}} (void)
\begin{DoxyCompactList}\small\item\em Cette fonction initialise la table d\textquotesingle{}inodes pour la premiere fois. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Ecrit le super bloc de la variable systemesur le disque. 
...
Lis la valeur du super bloc sur le disque et l\textquotesingle{}ecrit sur la variable systeme. 
...
Met a jour le premier octet libre du super bloc dans la variable du systeme et non sur le disque. 


\begin{DoxyParams}{Parameters}
{\em uint} & byte \+: octet a mettre a jour \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
void 
...
\end{DoxyPrecond}
\begin{DoxyNote}{Note}
Aucun test de verification d\textquotesingle{}espace disque n\textquotesingle{}est effectue, ajoute le first\+\_\+free\+\_\+byte au debut d\textquotesingle{}un nouveau bloc 
\end{DoxyNote}
...
Lis la valeur de la table d\textquotesingle{}inodes sur le disque et l\textquotesingle{}ecrit sur la variable systeme. 
...
Supprime une inode de la table d\textquotesingle{}inode et met a jour le super bloc. 


\begin{DoxyParams}{Parameters}
{\em int} & indice\+\_\+inode \+: indice de l\textquotesingle{}inode a supprimer \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int \+: 0 si tout s\textquotesingle{}est bien passe, 1 s\textquotesingle{}il y a eu une erreur, 2 si l\textquotesingle{}inode est deja libre 
\end{DoxyReturn}
\begin{DoxyPrecond}{Precondition}
variable systeme deja initialisee \&\& len(name\+\_\+of\+\_\+file) \texorpdfstring{$<$}{<} FILENAME\+\_\+\+MAX\+\_\+\+SIZE 
\end{DoxyPrecond}
\begin{DoxyNote}{Note}
La fonction gere si un indice qui correspond a aucun fichier est donne en parametre 
\end{DoxyNote}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
indice du premier inode libre ou -\/1 si tous les inodes sont occupes 
\end{DoxyReturn}
\begin{DoxyPrecond}{Precondition}
variable systeme deja initialisee 
\end{DoxyPrecond}
...
Ecrit un nouvel inode a la suite des autres sur la table d\textquotesingle{}inode. 


\begin{DoxyParams}{Parameters}
{\em name\+\_\+of\+\_\+file} & \+: nom du fichier \\
\hline
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int \+: indice du nouvel inode, -\/1 si erreurs (ex \+: taille max table inode atteinte) 
\end{DoxyReturn}
\begin{DoxyPrecond}{Precondition}
variable systeme deja initialisee \&\& len(name\+\_\+of\+\_\+file) \texorpdfstring{$<$}{<} FILENAME\+\_\+\+MAX\+\_\+\+SIZE 
\end{DoxyPrecond}
\begin{DoxyNote}{Note}
Met a jour le super bloc first\+\_\+free\+\_\+byte, nblock et number\+\_\+of\+\_\+files. 
\end{DoxyNote}
...
\begin{DoxyParams}{Parameters}
{\em char} & name\+\_\+of\+\_\+file\mbox{[}MAX\+\_\+\+FILE\+\_\+\+SIZE\mbox{]} \+: nom du fichier a chercher \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
variable systeme deja initialisee \&\& len(name\+\_\+of\+\_\+file) \texorpdfstring{$<$}{<}= FILENAME\+\_\+\+MAX\+\_\+\+SIZE 
\end{DoxyPrecond}
\mbox{\Hypertarget{Couche2_8h_a28781830c329397445a59105d8fab819}\label{Couche2_8h_a28781830c329397445a59105d8fab819}} 
...
{\footnotesize\ttfamily int init\+\_\+first\+\_\+time\+\_\+super\+\_\+block (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}



Cette fonction initialise le super bloc pour la premiere fois. 
...
variable systeme deja initialisee 
\end{DoxyPrecond}
\mbox{\Hypertarget{Couche2_8h_a145cc8db54fa03986cf5425c3eb54208}\label{Couche2_8h_a145cc8db54fa03986cf5425c3eb54208}} 
...
{\footnotesize\ttfamily int init\+\_\+first\+\_\+time\+\_\+inodes\+\_\+tables (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}



Cette fonction initialise la table d\textquotesingle{}inodes pour la premiere fois. 
